      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All Pending Withdrawer Requests</h3>
                ...
                <tr>
                    ...
                    <td>
                        <a onclick="fetchPost({{ $state->id }})">
                            <button type="button" class="btn btn-primary pd-x-10 pull-right" data-toggle="modal" data-target="#payuser"><i class="fa fa-check"></i> Pay User</button>
              </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="payuser" action="" method="post">
                            ...
                            <div class="modal-body">
                                <div class="row">
                        <p>Are you sure you want to Pay this User?
                        </p>
