      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All Pending Users Tasks</h3>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a onclick="fetchPost({{ $state->id }})">
                    <button type="button" class="btn btn-primary pd-x-10 pull-right" data-toggle="modal" data-target="#approveusertask"><i class="fa fa-check"></i> Approve</button>
      </a>
      <a onclick="rejectPost({{ $state->id }})">
        <button type="button" class="btn btn-danger pd-x-10 pull-right" data-toggle="modal" data-target="#rejecttask"><i class="fa fa-ban"></i> Reject </button>
</a>
                    </td>
                    </tr>
                  @endforeach
