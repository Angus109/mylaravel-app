...
<section class="content">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <table id="example" class="table table-bordered table-hover display nowrap margin-top-10">
              ...
              <button type="button" class="btn btn-danger pd-x-20 pull-right" data-toggle="modal" data-target="#promotersModal"><i class="fa fa-ban"></i> Close</button>
                    </a>
  ...
  <script>
    ...
    success: function(result){
        ...
        var url = 'activepromo/' + id;
        $('form#activepromo').attr('action', url);
