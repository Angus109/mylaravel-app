              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!--<a onclick="fetchPost({{ $entry->id }})"><button type="button" class="btn btn-primary pd-x-10 pull-right" data-toggle="modal" data-target="#approveusertask"><i class="fa fa-check"></i> Approve</button></a>-->
                        <!--<a onclick="rejectPost({{ $entry->id }})"><button type="button" class="btn btn-danger pd-x-10 pull-right" data-toggle="modal" data-target="#rejecttask"><i class="fa fa-ban"></i> Reject </button></a>-->
                    </td>
                    </tr>
                  @endforeach
                  @endif
