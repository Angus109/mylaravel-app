 ...
 <head>
    ...
    <div class="container">
        <div class="form-content">
            ...
            @endif
            <form method="POST" action="{{ route('login.user') }}" class="billing-details">
            @csrf
            ...
            <div class="form-footer">
                <p style="float: right">Don’t have an account? <a class="form-link" href="{{ route('register') }}">Sign Up</a></p>
                <p style="float: left">Forgot Password? <a class="form-link" href="{{ route('forgotpassword.password') }}">Forgot Password</a></p>
            </div>
        </div>
    </div>
