...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <head>
       ...
       <title>Reset Password  | {{$site->site_name}}</title>
    ...
    <div class="container">
        <div class="form-content">
            <div class="form-header">
                ...
                <p>Kindly enter your new Password and submit to update your account.</p>
            </div>
            ...
            @endif
            <form method="POST" action="{{ route('passwordreset') }}" class="billing-details">
            @csrf
