...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <head>
       ...
       <title>Verify OTP | {{$site->site_name}}</title>
    ...
    <div class="container">
        <div class="form-content">
            ...
            @endif
            <form method="POST" action="{{ route('verification') }}" class="billing-details">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="verified_otp" placeholder="Enter OTP" required>
                </div>
