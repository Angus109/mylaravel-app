...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <head>
       ...
       <title>Verify Password OTP | {{$site->site_name}}</title>
    ...
    <div class="container">
        <div class="form-content">
            ...
            @endif
            <form method="POST" action="{{ route('verifypassword.token') }}" class="billing-details">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="otp_token" placeholder="Enter OTP" required>
                </div>
                <button type="submit"  class="default-btn">Submit</button>
            </form>

            <div class="form-footer">
                <p>Didn get OTP? <a class="form-link" href="#">Resend OTP </a></p>
            </div>
        </div>
    </div>
