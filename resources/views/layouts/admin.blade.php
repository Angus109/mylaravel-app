...
<head>
    ...
    <link rel="icon" href="{{URL::to($site->logo)}}" type="image/x-icon">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../images/download.jpg" class="user-image" alt="User Image">
            </a>
            <ul class="dropdown-menu scale-up">
              <!-- User image -->
              <li class="user-header">
                <img src="../images/download.jpg" class="img-responsive" alt="User Image">
              ...
              <li>
                ...
                <ul class="menu inner-content-div">
                  ...
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('../images/112-1127972_choose-your-subscription-type-fa-fa-bullhorn-png.png')}}" class="img-circle" alt="User Image">
                      </div>
